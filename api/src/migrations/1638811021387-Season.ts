...
export class Season1638811021387 implements MigrationInterface {
    name = 'Season1638811021387'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "season" ("id" SERIAL NOT NULL, "name" character varying, "rounds" integer NOT NULL, "frequency" integer NOT NULL, "time" character varying NOT NULL, "startDate" TIMESTAMP WITH TIME ZONE NOT NULL, "teamNumbers" integer NOT NULL, "roundsPerDate" integer NOT NULL DEFAULT '1', "startLane" integer NOT NULL, "finished" boolean NOT NULL, "handicap" boolean NOT NULL, "scratch" boolean NOT NULL, "handicapPercent" integer, "handicapOf" integer, "hasMaxHandicap" boolean NOT NULL, "maxHandicap" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "leagueId" integer, CONSTRAINT "PK_8ac0d081dbdb7ab02d166bcda9f" PRIMARY KEY ("id"))`,
        )
        await queryRunner.query(
